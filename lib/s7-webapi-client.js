...
module.exports = {
    ...
    tokenOptions: function (url, configId) {
        const optionsToken = {
            method: 'post',
            url: url,
            data:
    ...
    */
    ...
    performRequest: async function (node, config) {

        const requestOptions = tokenOptions(config)
        const configId = config.id
